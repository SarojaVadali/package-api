...
const jwtConfig = require('./config/appsettings.json');
...
async function main(envelopeArgs){
  let accountInfo = await authenticate();
 // let args = getArgs(accountInfo.apiAccountId, accountInfo.accessToken, accountInfo.basePath,envelopeArgs);
  const args = {
  ...
  console.log('Access Token : ' + accountInfo.accessToken);
  console.log('Base Path : '+ accountInfo.basePath);
  console.log('Account Id : '+ accountInfo.apiAccountId);
